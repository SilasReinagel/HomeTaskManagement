...
class CreateTask extends Component {
    ...
    return (
      <div>
        <div>
          ...
          <br/>
          <TextField floatingLabelText="Units Of Work" type="numeric" onChange={(event, newValue) => this.setState({unitsOfWork:newValue})}/>
          <br/>            
  ...
  create() {
    ...
    axios
      .post("https://hometaskmanagement.azurewebsites.net/api/command/createtask", payload, { headers: {"Authorization" : "Bearer " + new Session().token()} })
